...
const file_piratas_proto_rawDesc = "" +
	...
	"\amensaje\x18\x02 \x01(\tR\amensaje2\xa6\x01\n" +
...
var file_piratas_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_piratas_proto_goTypes = []any{
	(*SolicitudLista)(nil),      // 0: onepiece.SolicitudLista
	(*PirataInfo)(nil),          // 1: onepiece.PirataInfo
	(*ListaPiratas)(nil),        // 2: onepiece.ListaPiratas
	(*ReporteCaptura)(nil),      // 3: onepiece.ReporteCaptura
	(*ConfirmacionCaptura)(nil), // 4: onepiece.ConfirmacionCaptura
}
var file_piratas_proto_depIdxs = []int32{
	1, // 0: onepiece.ListaPiratas.piratas:type_name -> onepiece.PirataInfo
	0, // 1: onepiece.GobiernoService.ObtenerListaPiratas:input_type -> onepiece.SolicitudLista
	3, // 2: onepiece.GobiernoService.ReportarCaptura:input_type -> onepiece.ReporteCaptura
	2, // 3: onepiece.GobiernoService.ObtenerListaPiratas:output_type -> onepiece.ListaPiratas
	4, // 4: onepiece.GobiernoService.ReportarCaptura:output_type -> onepiece.ConfirmacionCaptura
